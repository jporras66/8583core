...
public class Iso8583AppTest {

	static Logger log = Logger.getLogger( Iso8583AppTest.class.getName() ) ;
...
//	
	...
	public void iso8583Xml() {
		...
		if ( appdata.getAppName().equals("ISO8583CORE") ) {
			 System.out.println(className + "iso8583Xml  : TRUE  - " + appdata.getAppName() ) ;  
			 displayData ( appdata );
			 assertTrue( true) ;
		}else{
			 System.out.println(className + "iso8583Xml  : FALSE - " + appdata.getAppName() ) ;
			 assertFalse( true) ;
		}
	}
